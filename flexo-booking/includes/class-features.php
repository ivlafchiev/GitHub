	...
	public static function definitions() {
		return array(
			...
			'children'         => array(
				...
				'description' => __( 'Ask for children\'s ages, set a maximum number of adults per room, and charge per-person extras by age.', 'flexo-booking' ),
				'group'       => 'prices',
				'ready'       => true,
			),
			'tourist_tax'      => array(
				'label'       => __( 'Tourist tax', 'flexo-booking' ),
				'description' => __( 'Add the municipal tourist tax per person per night, included in the total or paid at the property.', 'flexo-booking' ),
				'group'       => 'prices',
				'ready'       => true,
			),
			'promo_codes'      => array(
			...
			'guest_emails'     => array(
				...
				'description' => __( 'Email guests when their booking is received, confirmed or cancelled, plus an optional reminder before arrival and a review request after the stay.', 'flexo-booking' ),
				'group'       => 'guests',
				'ready'       => true,
			),
			'tracking'         => array(
